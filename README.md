...
The code requires [Python 3.6](https://www.python.org/download/releases/3.6/), [Tensorflow 1.14](https://www.tensorflow.org/install/), as well as the following python libraries: 
